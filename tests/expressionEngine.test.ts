...
import { detectCyclicDependencies, FieldDependencyNode } from "../packages/expression-engine/src/analyzer/cycleDetector";
import { ExpressionEngine } from "../packages/expression-engine/src/ExpressionEngine";
import { EntitySchema } from "../packages/expression-engine/src/types";
...
describe("Expression Engine - Logical Viewpoint Suite", () => {
  ...
  describe("Engine Evaluation State Transitions", () => {
    it("should evaluate conditional visibility predicates deterministically", async () => {
      ...
      const schemaRules: EntitySchema = {
        $schemaVersion: "1.0.0",
        id: "test_schema",
        title: "Test Schema",
        fields: {
